...
/** Recuperación ante fallos inesperados del segmento del comedor. */
export default function ComedorError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    console.error('[comedor] error no controlado en la página', error)
  }, [error])
