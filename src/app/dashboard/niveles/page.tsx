...
export default async function NivelesPage() {
  ...
  const resultado = await listarNiveles()

  if (!resultado.ok) {
    return <PanelErrorLectura mensaje={resultado.mensaje} />
  }

  return <GestionNiveles niveles={resultado.datos} />
}
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      <div>
        ...
        <p className="text-neutral-500 text-sm mt-1">
          Administración del catálogo y su disponibilidad
        </p>
      </div>
      <div
        role="alert"
