 ...
 *
 * Mantiene el mismo contrato de accesibilidad que el diálogo de niveles
 * (EPT-55). Vive en el segmento de materias para no modificar esa pantalla
 * mientras EPT-56 está en curso; unificar ambos es trabajo de un incremento
 * de consolidación, no de esta historia.
 */
